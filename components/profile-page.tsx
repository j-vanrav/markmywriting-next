  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl p-3 flex flex-row w-full items-center gap-4">
        <div className="bg-black text-white size-12 min-w-12 rounded-md flex flex-row justify-center items-center">
          <Mail />
        </div>
      ...
      <div className="rounded-2xl flex flex-col items-center gap-4 w-full mb-16 mt-4">
        ...
        <Button
          onClick={() => {}}
          className="bg-gray-500 rounded-2xl w-full text-black"
          disabled={!!disabled}
